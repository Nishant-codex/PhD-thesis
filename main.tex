...
\noindent Based on: \href{https://doi.org/10.3390/nu13082752}{Willemsen, Y., Beijers, R., Arias Vásquez, A., de Weerth, C., Do Breastfeeding History and Diet Quality Predict Inhibitory Control at Preschool Age? \textit{Nutrients}, 2021, 13, 2752.}
...
%-------------------------------------------
\chapter{Heterogeneity in delay and timescales improves task Performance} 
% \ChapFrame
\thispagestyle{empty}
\AddToShipoutPictureBG*{%
  \AtPageLowerLeft{%
...
% \end{tikzpicture}
\include{Chapters/Discussion_Conclusion}
%-------------------------------------------
