...
\noindent Based on: \href{https://doi.org/10.1101/2024.10.16.618657}{Joshi, N., van Der Burg, S., Celikel, T., Zeldenrust, F., Neuronal Identity is Not Static—An Input-Driven Perspective \textit{bioRxiv}, 2024.10.16.618657.}
Under review at \textit{PLOS Computational Biology}.
...
%-------------------------------------------
\chapter{Timescale Heterogeneiety in Reservoir Computing} 
% \ChapFrame
\thispagestyle{empty}
\AddToShipoutPictureBG*{%
  \AtPageLowerLeft{%
...
\noindent Based on: $Iacob^{\dagger}, S.,Joshi^{\dagger}, N.$, Dambre, J., Zeldenrust, F., Timescale Heterogeneiety in Reservoir Computing. In preperation.
...
\include{Chapters/Supplementary_Materials}
% %-------------------------------------------
\chapter{Appendices}
\AddToShipoutPictureBG*{%
  \AtPageLowerLeft{%
...
\include{Chapters/Research data management statement}
\include{Chapters/outreach}
\include{Chapters/Failures}
\include{Chapters/Acknowledgements}
\include{Chapters/CV}
\include{Chapters/DGS}
\end{document}