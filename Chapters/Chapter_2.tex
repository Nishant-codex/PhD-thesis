...
0.8 suggesting that SH and FN action potential attributes are dissimilar. (\textbf{g}) Heatmap showing the likelihood of neurons to classify in one of the FN 
