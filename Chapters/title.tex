...
\noindent \textbf{Heterogeneity maketh the mind: An exploration of electrophysiological heterogeneity in cortical neurons}\\}
...
\newline \noindent Title: Heterogeneity maketh the mind: An exploration of electrophysiological heterogeneity in cortical neurons
\vspace{0.7cm}
...
\thispagestyle{empty}
  \begin{center}
       ...
       \textbf{\Large Heterogeneity maketh the mind: An exploration of electrophysiological heterogeneity in cortical neurons}\\
...
\newline{Prof. Dr. Tansu Celikel}
\vspace{1cm}
\newline{\textbf{Copromotoren:}}
\newline{Dr. Fleur Zeldenrust}
\vspace{1cm}
\newline{\textbf{Manuscriptcommissie:}}
% \newline{Prof. Dr. Sacha van Albada}
% \newline{Prof. Dr. Corette Wierenga}
% \newline{Dr. Martin Vinck}
